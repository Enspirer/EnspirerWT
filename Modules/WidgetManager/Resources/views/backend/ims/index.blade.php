        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('admin.ims.create',$widget->id)}}" class="btn btn-primary pull-right ml-4">Create New</a>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#villadatatable').DataTable({
                processing: true,
                ajax: "{{route('admin.ims.getdetails',$widget->id)}}",
                serverSide: true,
                order: [[0, "desc"]],
                columns: [
                    {data: 'id', name: 'id'},
