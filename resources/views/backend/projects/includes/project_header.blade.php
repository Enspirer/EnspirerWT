                            ...
                            <ul class="navbar-nav flex-wrap justify-content-around w-100">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link d-flex align-items-center font-weight-medium py-3 px-3" href="{{route('admin.projects.widget_manager',$project->id)}}">
                                        ...
                                        <span class="badge badge-warning ml-2">{{count(App\Models\Widgets::where('status','Enabled')->get())}}</span>
                                        <span class="badge badge-secondary ml-2">{{count(App\Models\Widgets::where('status','Disabled')->get())}}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
