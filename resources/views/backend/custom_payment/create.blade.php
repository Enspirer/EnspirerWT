...
@section('content')
    ...
    <form action="{{route('admin.custom_payment.store')}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="address" class="form-control" name="address" rows="2"></textarea>
                                </div>
                            </div>
                        </div>
