    ...
    <tr>
      <td align="center" style="padding:0;">
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 30px 0;color:#153643;" align="left">
                    <h1 style="font-size:20px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Tallentor - Login Details</h1>
                  </td>
                  <td style="padding:0 0 30px 0;color:#153643;" align="right">
                    <img src="{{url('images/logo/fev/apple-touch-icon.png')}}" style="width:100%; max-width:60px; margin:0 0 20px 0;">                    
                  </td>
                </tr>
                <tr>
                  <td style="padding:0 0 30px 0;color:#153643;">
                    <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Dear {{ $user_details['name'] }},</p>
                    <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Thank you for registered with Tallentor. This is your login credential in order to log into our website.</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0;">
          ...
          <tr>
            <td style="padding:30px;background:#1f2851;">
