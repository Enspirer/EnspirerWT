              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 10px 0;color:#153643;" align="left">
                    <h1 style="font-size:20px;margin:0 0 10px 0;font-family:Arial,sans-serif;">Tallentor Digital - Free Consultation</h1>
                  </td>
                    ...
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                      <tr>
                        <td style="width:30%;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Date:</p>
                          <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Time:</p>
                        ...
                        <td style="padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">{{ $details['company'] }}</p>
                          <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">{{ $details['date'] }}</p>
                          <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">{{ $details['time'] }}</p>
