                                                            ...
                                                            <div class="row-data">
                                                                <div class="row-info">
                                                                    <div class="info">
                                                                        ...
                                                                        <div class="text">{{ $campaign->value }}</div>
                                                                        <div class="icon-secondary"><a href="#"><i class="bi bi-box-arrow-up-right"></i></a></div>
                                                                    </div>
                                                                    <div class="count">
                                                                        <div class="total-count">{{ number_format($campaign->count, 0, __('.'), __(',')) }}</div>
                                                                        <div class="total-precentage">{{ number_format((($campaign->count / $total->count) * 100), 1, __('.'), __(',')) }}%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="row-progress">
                                                                    <div class="progress">
                                                                        <div class="progress-bar" role="progressbar" style="width: {{ (($campaign->count / $total->count) * 100) }}%" aria-valuenow="25"
