                                                        ...
                                                        @foreach($devices as $device)
                                                            <div class="row-data">
                                                                <div class="row-info">
                                                                    ...
                                                                    <div class="count">
                                                                        <div class="total-count">{{ number_format($device->count, 0, __('.'), __(',')) }}</div>
                                                                        <div class="total-precentage">{{ number_format((($device->count / $total->count) * 100), 1, __('.'), __(',')) }}%</div>
                                                                    </div>
                                                                </div>
                                                                <div class="row-progress">
                                                                    <div class="progress">
                                                                        <div class="progress-bar" role="progressbar" style="width: {{ (($device->count / $total->count) * 100) }}%" aria-valuenow="25"
