...
<link rel="stylesheet" href="{{url('css/all_in_one_widget_settings.css')}}">
    ...
    <div class="side-nav-section">
        <div id="sideNav" class="side-nav">
            <div class="side-nav-brands">
                <img class="brand-image" src="{{url('images/sidenav.png')}}" alt="brand-image">
            ...
            <div class="side-navs">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" id="channelNav" onclick="innerSection('channel-block')"
                            href="#">
                            <span class="text">Channel</span>
                            <span class="tool-tip">Channel</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="templateNav" onclick="innerSection('template-block')"
                            href="#">
        ...
        <div id="sideNavInner">
            <div class="row g-0">
                ...
                <div id="channel-block" class="inner-section">
                        ...
                        <div class="footer">
                            ...
                            <div class="button-block">
                                ...
                                <input type="hidden" id="hidden_template_id" name="hidden_template_id"
                                    value="{{ json_decode($widget->settings)[0]->template_layout }}" />
